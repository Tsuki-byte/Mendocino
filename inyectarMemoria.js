...
<ul>
    <li><strong>Tensión de Vacío (Voc):</strong> Tensión máxima de la placa cuando no hay carga conectada.</li>
...
window.ejecutarSimulacionTesla = async function() {
    ...
    const payload = {
        ...
        topload_capacitance_pF: parseFloat(document.getElementById('tesla-ctop').value) || 0
    };
